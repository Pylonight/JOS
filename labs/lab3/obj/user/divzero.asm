...
umain(void)
{
  ...
  800037:	83 ec 18             	sub    $0x18,%esp
	cprintf("1/0 is %08x!\n", 1/zero);
  80003a:	b8 01 00 00 00       	mov    $0x1,%eax
  80003f:	89 c2                	mov    %eax,%edx
  800041:	c1 fa 1f             	sar    $0x1f,%edx
  800044:	f7 3d 04 20 80 00    	idivl  0x802004
  80004a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80004e:	c7 04 24 f8 0e 80 00 	movl   $0x800ef8,(%esp)
  800055:	e8 09 01 00 00       	call   800163 <cprintf>
}
  80005a:	c9                   	leave  
  80005b:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80006e:	e8 45 0b 00 00       	call   800bb8 <sys_getenvid>
...
exit(void)
{
  ...
  8000b9:	e8 9d 0a 00 00       	call   800b5b <sys_env_destroy>
}
  8000be:	c9                   	leave  
  8000bf:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000ed:	e8 0a 0a 00 00       	call   800afc <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80013e:	e8 d1 01 00 00       	call   800314 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800156:	e8 a1 09 00 00       	call   800afc <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800246:	0f be 80 1d 0f 80 00 	movsbl 0x800f1d(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a8:	ff 24 85 ac 0f 80 00 	jmp    *0x800fac(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800490:	c7 44 24 08 3e 0f 80 	movl   $0x800f3e,0x8(%esp)
  800497:	00 
  ...
  8004c5:	ba 2e 0f 80 00       	mov    $0x800f2e,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b8e:	00 
  800b8f:	c7 44 24 08 20 11 80 	movl   $0x801120,0x8(%esp)
  800b96:	00 
  800b97:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b9e:	00 
  800b9f:	c7 04 24 3d 11 80 00 	movl   $0x80113d,(%esp)
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800beb:	83 ec 18             	sub    $0x18,%esp
	...
	if (argv0)
  800bee:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800bf3:	85 c0                	test   %eax,%eax
  800bf5:	74 10                	je     800c07 <_panic+0x1f>
		cprintf("%s: ", argv0);
  800bf7:	89 44 24 04          	mov    %eax,0x4(%esp)
  800bfb:	c7 04 24 4b 11 80 00 	movl   $0x80114b,(%esp)
  800c02:	e8 5c f5 ff ff       	call   800163 <cprintf>
  ...
  800c1e:	c7 04 24 50 11 80 00 	movl   $0x801150,(%esp)
  800c25:	e8 39 f5 ff ff       	call   800163 <cprintf>
	vcprintf(fmt, ap);
  ...
  800c37:	e8 c6 f4 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  800c3c:	c7 04 24 04 0f 80 00 	movl   $0x800f04,(%esp)
  800c43:	e8 1b f5 ff ff       	call   800163 <cprintf>
