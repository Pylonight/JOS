...
umain(void)
{
  ...
  80004e:	c7 04 24 e8 0e 80 00 	movl   $0x800ee8,(%esp)
  800055:	e8 f1 00 00 00       	call   80014b <cprintf>
}
  80005a:	c9                   	leave  
  80005b:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800065:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	env = 0;
  800068:	c7 05 08 20 80 00 00 	movl   $0x0,0x802008
  80006f:	00 00 00 
...
exit(void)
{
  ...
  8000a1:	e8 a5 0a 00 00       	call   800b4b <sys_env_destroy>
}
  8000a6:	c9                   	leave  
  8000a7:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000b7:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  ...
  8000d5:	e8 12 0a 00 00       	call   800aec <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800126:	e8 d9 01 00 00       	call   800304 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80013e:	e8 a9 09 00 00       	call   800aec <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800236:	0f be 80 0d 0f 80 00 	movsbl 0x800f0d(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800398:	ff 24 85 9c 0f 80 00 	jmp    *0x800f9c(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800480:	c7 44 24 08 2e 0f 80 	movl   $0x800f2e,0x8(%esp)
  800487:	00 
  ...
  8004b5:	ba 1e 0f 80 00       	mov    $0x800f1e,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b7e:	00 
  800b7f:	c7 44 24 08 10 11 80 	movl   $0x801110,0x8(%esp)
  800b86:	00 
  800b87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8e:	00 
  800b8f:	c7 04 24 2d 11 80 00 	movl   $0x80112d,(%esp)
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800bdb:	83 ec 18             	sub    $0x18,%esp
	...
	if (argv0)
  800bde:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800be3:	85 c0                	test   %eax,%eax
  800be5:	74 10                	je     800bf7 <_panic+0x1f>
		cprintf("%s: ", argv0);
  800be7:	89 44 24 04          	mov    %eax,0x4(%esp)
  800beb:	c7 04 24 3b 11 80 00 	movl   $0x80113b,(%esp)
  800bf2:	e8 54 f5 ff ff       	call   80014b <cprintf>
  ...
  800c0e:	c7 04 24 40 11 80 00 	movl   $0x801140,(%esp)
  800c15:	e8 31 f5 ff ff       	call   80014b <cprintf>
	vcprintf(fmt, ap);
  ...
  800c27:	e8 be f4 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800c2c:	c7 04 24 f4 0e 80 00 	movl   $0x800ef4,(%esp)
  800c33:	e8 13 f5 ff ff       	call   80014b <cprintf>
