	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800226:	0f be 80 17 0f 80 00 	movsbl 0x800f17(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800388:	ff 24 85 a4 0f 80 00 	jmp    *0x800fa4(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800470:	c7 44 24 08 38 0f 80 	movl   $0x800f38,0x8(%esp)
  800477:	00 
  ...
  8004a5:	ba 28 0f 80 00       	mov    $0x800f28,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b6e:	00 
  800b6f:	c7 44 24 08 18 11 80 	movl   $0x801118,0x8(%esp)
  800b76:	00 
  800b77:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b7e:	00 
  800b7f:	c7 04 24 35 11 80 00 	movl   $0x801135,(%esp)
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800bdb:	c7 04 24 43 11 80 00 	movl   $0x801143,(%esp)
  ...
  800bfe:	c7 04 24 48 11 80 00 	movl   $0x801148,(%esp)
  ...
  800c17:	e8 c6 f4 ff ff       	call   8000e2 <vcprintf>
	cprintf("\n");
  800c1c:	c7 04 24 64 11 80 00 	movl   $0x801164,(%esp)
