	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800246:	0f be 80 37 0f 80 00 	movsbl 0x800f37(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a8:	ff 24 85 c4 0f 80 00 	jmp    *0x800fc4(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800490:	c7 44 24 08 58 0f 80 	movl   $0x800f58,0x8(%esp)
  800497:	00 
  ...
  8004c5:	ba 48 0f 80 00       	mov    $0x800f48,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800b8e:	00 
  800b8f:	c7 44 24 08 38 11 80 	movl   $0x801138,0x8(%esp)
  800b96:	00 
  800b97:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b9e:	00 
  800b9f:	c7 04 24 55 11 80 00 	movl   $0x801155,(%esp)
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800bfb:	c7 04 24 63 11 80 00 	movl   $0x801163,(%esp)
  ...
  800c1e:	c7 04 24 68 11 80 00 	movl   $0x801168,(%esp)
  ...
  800c37:	e8 be f4 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800c3c:	c7 04 24 84 11 80 00 	movl   $0x801184,(%esp)
