...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	00 
  80011b:	c7 44 24 08 df 0e 80 	movl   $0x800edf,0x8(%esp)
  800122:	00 
  800123:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012a:	00 
  80012b:	c7 04 24 fc 0e 80 00 	movl   $0x800efc,(%esp)
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800177:	83 ec 18             	sub    $0x18,%esp
	...
	if (argv0)
  80017a:	a1 08 20 80 00       	mov    0x802008,%eax
  80017f:	85 c0                	test   %eax,%eax
  800181:	74 10                	je     800193 <_panic+0x1f>
		cprintf("%s: ", argv0);
  800183:	89 44 24 04          	mov    %eax,0x4(%esp)
  800187:	c7 04 24 0a 0f 80 00 	movl   $0x800f0a,(%esp)
  80018e:	e8 e8 00 00 00       	call   80027b <cprintf>
  ...
  8001a1:	a1 00 20 80 00       	mov    0x802000,%eax
  8001a6:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001aa:	c7 04 24 0f 0f 80 00 	movl   $0x800f0f,(%esp)
  8001b1:	e8 c5 00 00 00       	call   80027b <cprintf>
	vcprintf(fmt, ap);
  8001b6:	8d 45 14             	lea    0x14(%ebp),%eax
  8001b9:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001bd:	8b 45 10             	mov    0x10(%ebp),%eax
  8001c0:	89 04 24             	mov    %eax,(%esp)
  8001c3:	e8 52 00 00 00       	call   80021a <vcprintf>
	cprintf("\n");
  8001c8:	c7 04 24 2b 0f 80 00 	movl   $0x800f2b,(%esp)
  8001cf:	e8 a7 00 00 00       	call   80027b <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8001d4:	cc                   	int3   
  8001d5:	eb fd                	jmp    8001d4 <_panic+0x60>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800256:	e8 d9 01 00 00       	call   800434 <vprintfmt>
	sys_cputs(b.buf, b.idx);
