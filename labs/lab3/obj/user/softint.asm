...
sys_env_destroy(envid_t envid)
{
  ...
  800132:	00 
  800133:	c7 44 24 08 ef 0e 80 	movl   $0x800eef,0x8(%esp)
  80013a:	00 
  80013b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800142:	00 
  800143:	c7 04 24 0c 0f 80 00 	movl   $0x800f0c,(%esp)
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80018f:	83 ec 18             	sub    $0x18,%esp
	...
	if (argv0)
  800192:	a1 08 20 80 00       	mov    0x802008,%eax
  800197:	85 c0                	test   %eax,%eax
  800199:	74 10                	je     8001ab <_panic+0x1f>
		cprintf("%s: ", argv0);
  80019b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80019f:	c7 04 24 1a 0f 80 00 	movl   $0x800f1a,(%esp)
  8001a6:	e8 e8 00 00 00       	call   800293 <cprintf>
  ...
  8001c2:	c7 04 24 1f 0f 80 00 	movl   $0x800f1f,(%esp)
  8001c9:	e8 c5 00 00 00       	call   800293 <cprintf>
	vcprintf(fmt, ap);
  8001ce:	8d 45 14             	lea    0x14(%ebp),%eax
  ...
  8001db:	e8 52 00 00 00       	call   800232 <vcprintf>
	cprintf("\n");
  8001e0:	c7 04 24 3b 0f 80 00 	movl   $0x800f3b,(%esp)
  8001e7:	e8 a7 00 00 00       	call   800293 <cprintf>
	...
	while (1)
		asm volatile("int3");
  8001ec:	cc                   	int3   
  8001ed:	eb fd                	jmp    8001ec <_panic+0x60>
	...
