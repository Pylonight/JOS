...
sys_env_destroy(envid_t envid)
{
  ...
  80013a:	00 
  80013b:	c7 44 24 08 ff 0e 80 	movl   $0x800eff,0x8(%esp)
  800142:	00 
  800143:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014a:	00 
  80014b:	c7 04 24 1c 0f 80 00 	movl   $0x800f1c,(%esp)
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800197:	83 ec 18             	sub    $0x18,%esp
	...
	if (argv0)
  80019a:	a1 08 20 80 00       	mov    0x802008,%eax
  80019f:	85 c0                	test   %eax,%eax
  8001a1:	74 10                	je     8001b3 <_panic+0x1f>
		cprintf("%s: ", argv0);
  8001a3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001a7:	c7 04 24 2a 0f 80 00 	movl   $0x800f2a,(%esp)
  8001ae:	e8 e8 00 00 00       	call   80029b <cprintf>
  ...
  8001ca:	c7 04 24 2f 0f 80 00 	movl   $0x800f2f,(%esp)
  8001d1:	e8 c5 00 00 00       	call   80029b <cprintf>
	vcprintf(fmt, ap);
  8001d6:	8d 45 14             	lea    0x14(%ebp),%eax
  ...
  8001e3:	e8 52 00 00 00       	call   80023a <vcprintf>
	cprintf("\n");
  8001e8:	c7 04 24 4b 0f 80 00 	movl   $0x800f4b,(%esp)
  8001ef:	e8 a7 00 00 00       	call   80029b <cprintf>
	...
	while (1)
		asm volatile("int3");
  8001f4:	cc                   	int3   
  8001f5:	eb fd                	jmp    8001f4 <_panic+0x60>
	...
...
putch(int ch, struct printbuf *b)
{
  ...
  800225:	e8 7e fe ff ff       	call   8000a8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800276:	e8 d9 01 00 00       	call   800454 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80028e:	e8 15 fe ff ff       	call   8000a8 <sys_cputs>
