...
sys_env_destroy(envid_t envid)
{
  ...
  800122:	00 
  800123:	c7 44 24 08 df 0e 80 	movl   $0x800edf,0x8(%esp)
  80012a:	00 
  80012b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800132:	00 
  800133:	c7 04 24 fc 0e 80 00 	movl   $0x800efc,(%esp)
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80017f:	83 ec 18             	sub    $0x18,%esp
	...
	if (argv0)
  800182:	a1 08 20 80 00       	mov    0x802008,%eax
  800187:	85 c0                	test   %eax,%eax
  800189:	74 10                	je     80019b <_panic+0x1f>
		cprintf("%s: ", argv0);
  80018b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80018f:	c7 04 24 0a 0f 80 00 	movl   $0x800f0a,(%esp)
  800196:	e8 e8 00 00 00       	call   800283 <cprintf>
  ...
  8001b2:	c7 04 24 0f 0f 80 00 	movl   $0x800f0f,(%esp)
  8001b9:	e8 c5 00 00 00       	call   800283 <cprintf>
	vcprintf(fmt, ap);
  8001be:	8d 45 14             	lea    0x14(%ebp),%eax
  8001c1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001c5:	8b 45 10             	mov    0x10(%ebp),%eax
  8001c8:	89 04 24             	mov    %eax,(%esp)
  8001cb:	e8 52 00 00 00       	call   800222 <vcprintf>
	cprintf("\n");
  8001d0:	c7 04 24 2b 0f 80 00 	movl   $0x800f2b,(%esp)
  8001d7:	e8 a7 00 00 00       	call   800283 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8001dc:	cc                   	int3   
  8001dd:	eb fd                	jmp    8001dc <_panic+0x60>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80025e:	e8 d1 01 00 00       	call   800434 <vprintfmt>
	sys_cputs(b.buf, b.idx);
